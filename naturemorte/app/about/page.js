    ...
    <section className="py-20 lg:py-32 bg-white" id="about">
      ...
      >
        <div className="max-w-6xl mx-auto">
          <div className="mb-16">
            <h2 className="text-4xl lg:text-6xl mb-8 font-semibold text-black">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            ...
            <div className="text-center p-6">
              ...
              <h3 className="text-xl mb-3 font-semibold">Artist Support</h3>
              <p className="text-gray-600">
          ...
          <div className="bg-gray-50 p-8 lg:p-12 rounded-lg">
            <h3 className="text-3xl mb-6 font-semibold">Landmark Projects</h3>
